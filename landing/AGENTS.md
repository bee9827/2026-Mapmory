...
- Use self-hosted LINE Seed Sans KR Regular/Bold as the single interface and body family. Reserve Nanum Pen Script for actual memory words and record captions only; avoid decorative English eyebrow copy and extra font families.
