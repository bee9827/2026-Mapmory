...
- Latest 2026-09-23 follow-up pauses capture-volume inference: without usable GPS/date anchors put all photos into one holding album, regardless of capture volume. Retain conservative location/date and bounded time-linking rules when anchors exist. Track missing GPS separately from classification success; exclude Android non-Kakao from product-effect evaluation as before.
