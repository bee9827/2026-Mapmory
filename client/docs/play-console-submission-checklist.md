...
- [ ] Firebase Analytics의 앱 활동·기기 또는 기타 ID 수집과 분석 목적을 데이터 보안 응답에 반영했는가
- [ ] 사용자 태그 이름이 Analytics로 전송된다는 점을 사용자 생성 콘텐츠 항목에 반영했는가
- [ ] 광고·광고 개인화를 사용하지 않도록 Firebase·GA4 설정을 확인했는가
- [ ] 사용자 ID, 사용자 생성 콘텐츠, 사진, 위치, 앱 활동, 기기 또는 기타 ID와 앱 정보 및 성능 항목을 최종 AAB 기준으로 검증했는가
